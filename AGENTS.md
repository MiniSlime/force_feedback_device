...
- **コマンド**:
  - `"0"`, `"45"`, `"90"`, `"135"`, `"180"`, `"225"`, `"270"`, `"315"`: モーターを指定方向に3秒間動作
  - `"BLINK"`: LED点滅
  - その他: LED一定時間点灯
...
- **機能**:
  ...
  - LED制御（点滅・点灯）
- **モーター制御**:
  - `controlMotor(direction, enabled)`: 指定方向（0-360度）に推力発生
  - `controlMotorSingle(inaPin, inbPin, thrust)`: 単一モーター制御
...
P001,horizontal_force,0,90,87.5,2340
...
```
